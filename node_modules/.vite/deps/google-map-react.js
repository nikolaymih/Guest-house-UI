...
function H(e2) {
  ...
  return "function" == typeof o2 && o2 instanceof o2 && U(o2) === U(Object);
}
...
var B;
var W = "undefined" != typeof document && document.attachEvent;
var V = false;
if (G && !W) {
  F = function() {
  ...
  if (G) {
    oe = document.createElement("fakeelement");
    if (void 0 !== oe.style.animationName && (X = true), false === X) {
  ...
  re = "resizeanim", ie = "@" + J + "keyframes " + re + " { from { opacity: 0; } to { opacity: 0; } } ", se = J + "animation: 1ms " + re + "; ";
}
var F;
var $;
var q;
...
var ie;
var se;
var ae = void 0 !== import_react_dom.default.createPortal;
var pe = ae ? import_react_dom.default.createPortal : import_react_dom.default.unstable_renderSubtreeIntoContainer;
var le = function(e2) {
...
var he = function(t2) {
  function o2(o3) {
    ...
    if ((r3 = t2.call(this, o3) || this)._getMinZoom = function() {
      ...
      if (!r3.initialized_) {
        ...
        r3.props.googleMapLoader(t3, r3.props.heatmapLibrary).then(function(e3) {
          if (r3.mounted_) {
            ...
            var p2 = P(e3, H), u2 = "function" == typeof r3.props.options ? r3.props.options(p2) : r3.props.options, h2 = !A(r3.props.draggable) && { draggable: r3.props.draggable }, c2 = r3._computeMinZoom(u2.minZoom);
            r3.minZoom_ = c2;
            ...
            var _2 = e3.version.match(/^3\.(\d+)\./), f2 = _2 && Number(_2[1]), v2 = l(r3), M2 = Object.assign(new e3.OverlayView(), { onAdd: function() {
              ...
              this.getPanes().overlayMouseTarget.appendChild(n2), v2.geoService_.setMapCanvasProjection(e3, M2.getProjection()), ae ? v2.setState({ overlay: n2 }) : pe(v2, v2._renderPortal(), n2, function() {
                return v2.setState({ overlay: n2 });
              });
            }, onRemove: function() {
              var e4 = v2.state.overlay;
              e4 && !ae && import_react_dom.default.unmountComponentAtNode(e4), v2.setState({ overlay: null });
            }, draw: function() {
      ...
      return e2 && (H(e2) && N(e2.lat) && N(e2.lng) || 2 === e2.length && N(e2[0]) && N(e2[1]));
  ...
  return r2.componentDidMount = function() {
    ...
    this.props.googleMapLoader(o3, this.props.heatmapLibrary), setTimeout(function() {
      ...
      e3 = e3.parentNode, W ? e3.attachEvent("onresize", t4) : (e3.__resizeTriggers__ || ("static" == getComputedStyle(e3).position && (e3.style.position = "relative"), function() {
        if (!V) {
    ...
    if (_(e2.defaultCenter, this.props.defaultCenter) || console.warn("GoogleMap: defaultCenter prop changed. You can't change default props."), _(e2.defaultZoom, this.props.defaultZoom) || console.warn("GoogleMap: defaultZoom prop changed. You can't change default props."), !this._isCenterDefined(e2.center) && this._isCenterDefined(this.props.center) && setTimeout(function() {
      ...
      if (this._isCenterDefined(this.props.center)) {
        var n2 = le(this.props.center), r3 = this._isCenterDefined(e2.center) ? le(e2.center) : null;
      ...
      if (A(this.props.zoom) || Math.abs(this.props.zoom - e2.zoom) > 0 && this.map_.setZoom(this.props.zoom), !A(e2.draggable) && A(this.props.draggable) ? this.map_.setOptions({ draggable: this.defaultDraggableOption_ }) : _(e2.draggable, this.props.draggable) || this.map_.setOptions({ draggable: this.props.draggable }), !A(this.props.options) && !_(e2.options, this.props.options)) {
        var i = P(this.maps_, H), s2 = "function" == typeof this.props.options ? this.props.options(i) : this.props.options;
        if ("minZoom" in (s2 = d(s2, ["zoom", "center", "draggable"]))) {
          var a2 = this._computeMinZoom(s2.minZoom);
          s2.minZoom = ue(s2.minZoom, a2);
        }
    ...
    return import_react.default.createElement("div", { style: this.props.style, onMouseMove: this._onMapMouseMove, onMouseDownCapture: this._onMapMouseDownCapture, onClick: this._onMapClick }, import_react.default.createElement(h, { registerChild: this._registerChild }), ae && t3 && pe(this._renderPortal(), t3), o3);
  }, o2;
}(import_react.Component);
function ce(e2) {
...
function me(e2, t2, o2, n2) {
  var r2 = ce(e2), i = ce(t2), s2 = r2.x < i.x ? i.x - r2.x : 1 - r2.x + i.x, a2 = i.y - r2.y;
  if (s2 <= 0 && a2 <= 0)
    return null;
  var p2 = E(o2 / 256 / Math.abs(s2)), l2 = E(n2 / 256 / Math.abs(a2)), u2 = Math.floor(1e-9 + Math.min(p2, l2)), h2 = { x: r2.x < i.x ? 0.5 * (r2.x + i.x) : r2.x + i.x - 1 > 0 ? 0.5 * (r2.x + i.x - 1) : 0.5 * (1 + r2.x + i.x), y: 0.5 * (r2.y + i.y) }, c2 = Math.pow(2, u2), d2 = o2 / c2 / 256 / 2, m2 = n2 / c2 / 256 / 2, g2 = de({ x: h2.x - d2, y: h2.y - m2 }), _2 = de({ x: h2.x + d2, y: h2.y + m2 });
  return { center: de(h2), zoom: u2, newBounds: { nw: g2, se: _2 } };
}
function ge(e2) {
...
function fe(e2, t2) {
  ...
  if (n2 && r2)
    ...
    var u2 = ge({ ne: i, sw: s2 });
    o2 = me(u2.nw, u2.se, p2, l2);
  }
  return a({}, o2, { newBounds: a({}, o2.newBounds, _e(o2.newBounds)) });
}
function ve(e2, t2, o2) {
  var n2 = function(e3, t3) {
    ...
    }(e3, { lat: t3.lat, lng: t3.lng }), n3 = o3.se, r3 = ce(o3.nw), i2 = ce(n3);
...
function ye(e2, t2) {
  var o2 = ce({ lat: e2.lat, lng: e2.lng }), n2 = Math.pow(2, t2);
